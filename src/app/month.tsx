    ...
    <section className="h-full rounded-[28px] border border-white/50 bg-white/75 p-5 shadow-[0_10px_30px_rgba(0,0,0,0.05)] backdrop-blur-xl">
      ...
      <div className="mb-5">
        ...
        <p className="mt-4 text-sm text-zinc-500">
          Hover or tap any row to view all translations
        </p>
      ...
      <div className="space-y-3">
        ...
        {months.map((month, idx) => (
          <div
            key={month.english}
            className="group overflow-hidden rounded-2xl border border-zinc-100 bg-white transition-all duration-300 ease-out hover:-translate-y-0.5 hover:border-zinc-200 hover:shadow-[0_14px_30px_rgba(15,23,42,0.08)]"
          >
            ...
            {/* Hover Dropdown */}
            <div
              className={`overflow-hidden border-t bg-zinc-50 px-4 transition-all duration-300 ease-out group-hover:max-h-40 group-hover:border-zinc-100 ${
                expandedMonth === idx
